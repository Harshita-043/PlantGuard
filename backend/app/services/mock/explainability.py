...
class MockExplainabilityService(ExplainabilityService):
    """
    Mock implementation of ExplainabilityService.
    Returns fixed Grad-CAM style visualizations for testing.
    """

    def __init__(self):
        logger.info("Initializing MOCK ExplainabilityService")
        self._ready = True

    def initialize(self) -> None:
        """Initialize the mock service."""
        logger.info("MockExplainabilityService initialized")
        self._ready = True
    ...
    def generate_explanation(
        ...
        """
        logger.debug("Using MOCK ExplainabilityService")
